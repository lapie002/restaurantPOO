...
if(isset($_SESSION['login'])){
  ...
  if(isset($_SESSION['suppressionMenu']))
  {
    ...
    {
       $message = "<div class='alert alert-danger fade in col-lg-6'><a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a><strong>Erreur !</strong> le menu n'a pas été supprimé de la base de données.</div>";
    }
  }
        ...
        <div id="page-wrapper">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <h1 class="page-header">
                                    La Liste des <?= $menusManager->count() ?> Menus
                                </h1>
                            </div>
                            <div class="col-lg-12">
                            <?php
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3">
                                <a href="http://localhost/restaurantPOO/addmenu.php"><button type="button" class="btn btn-success"><i class="fa fa-plus" aria-hidden="true"></i></button></a>
                            </div>
                        </div>
                        <!-- /.row -->
                                                              ...
                                                              <div class="modal-dialog">
                                                                ...
                                                                <div class="modal-content">
                                                                  ...
                                                                  <div class="modal-footer">
                                                                    <a href="http://localhost/restaurantPOO/deletemenu.php?id=<?=$num;?>"><button type="button" class="btn btn-default">Supprimer</button></a>
