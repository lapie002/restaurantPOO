...
// on recupere l id du menu passe en parametre
...
<div id="wrapper">
        ...
        <div id="page-wrapper">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <h1 class="page-header">
                                  <?php
                                    $nbPlats = $menusManager->countPlat($idDuMenu);
                                  ?>
                                    La Liste des <?=$nbPlats; ?> Plats correspondant au Menu sélectionné
                                </h1>
                            </div>
                            <div class="col-lg-12">
                            <?php
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <h2>Tableau des Plats associés au Menu</h2>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                        ...
                                                        foreach($plats as $plat){
                                                          echo "<td><img class='media-object' src='uploads/" . $plat->getImage() . "' alt='' style='width:60px;height:60px;'></td>";
                                                        }
                                                        ?>
                                            </tr>
